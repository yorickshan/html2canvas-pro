 ...
 * @param rgb
 */
export const rec20202rec2020Linear = (rgb: [number, number, number]) => {
 ...
 * @param rgb
 */
export const rec2020Linear2rec2020 = (rgb: [number, number, number]) => {
    const a = 1.09929682680944;
    const b = 0.018053968510807;
    return rgb.map(function (c) {
 ...
 * @param rec
 */
export const rec2020LinearToXyz = (rec: [number, number, number]) => {
 ...
 * @param xyz
 */
export const xyzToRec2020Linear = (xyz: [number, number, number]) => {
    return multiplyMatrices(
        [
            // eslint-disable-next-line prettier/prettier
 ...
 * @param args
 */
export const rec2020ToXYZ = (args: number[]) => {
 ...
 * @param args
 */
export const convertRec2020 = (args: number[]) => {

...
var CanvasRenderer = /** @class */ (function (_super) {
    ...
    function CanvasRenderer(context, options) {
        ...
        _this.canvas.style.imageRendering = options.imageSmoothingEnabled ? 'auto' : 'pixelated';
        _this.ctx = _this.canvas.getContext('2d');
        _this.ctx.imageSmoothingEnabled = options.imageSmoothingEnabled;
        if (!options.canvas) {
                                ...
                                switch (_h.label) {
                                    ...
                                    case 5:
                                        if (isLinearGradient(backgroundImage)) {
                                            ...
                                            canvas.style.imageRendering = this_1.options.imageSmoothingEnabled ? 'auto' : 'pixelated';
                                            canvas.width = width;
                                            canvas.height = height;
                                            ctx = canvas.getContext('2d');
                                            ctx.imageSmoothingEnabled = this_1.options.imageSmoothingEnabled;
        ...
        switch (_v.label) {
            ...
            case 1:
                ...
                renderOptions = {
                    ...
                    imageSmoothingEnabled: (_t = opts.imageSmoothingEnabled) !== null && _t !== void 0 ? _t : true
                };
